...
public class UserRegistrationService {
    ...
    @Transactional
    public ResponseEntity<String> registerUser(Registration registration) throws JsonProcessingException {
        ...
        try {
            ...
            if (user.isPresent()) {
                ...
                //TODO send email for the user to confirm registration
