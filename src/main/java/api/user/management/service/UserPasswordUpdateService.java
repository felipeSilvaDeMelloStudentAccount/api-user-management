...
public class UserPasswordUpdateService {
    ...
    public ResponseEntity<String> updateUserPassword(String userid, PasswordUpdate passwordUpdate) throws JsonProcessingException {
        ...
        try {
            ...
            if (optionalUser.isEmpty()) {
                ...
                ErrorClass errorClass = ErrorClass.builder()
                        ...
                        .build();
                return ResponseEntity.status(HttpStatus.NOT_FOUND).body(objectMapper.writeValueAsString(errorClass));
            }
            if (!encoder.matches(passwordUpdate.getCurrentPassword(), optionalUser.get().getPassword())) {
                ...
                ErrorClass errorClass = ErrorClass.builder()
                        ...
                        .build();
                return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(objectMapper.writeValueAsString(errorClass));
            } else {
                // Encode password
            ...
            ErrorClass errorClass = ErrorClass.builder()
                    ...
                    .build();
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(objectMapper.writeValueAsString(errorClass));
